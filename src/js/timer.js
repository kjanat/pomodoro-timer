class PomodoroTimer {
    ...
    bindEvents() {
        ...
        document.getElementById('auto-start-focus').addEventListener('change', (e) => {
    ...
    advanceMode() {
        if (this.state.mode === 'focus') {
            ...
            if (this.state.completedSessions % this.settings.longBreakInterval === 0) {
    ...
    updateStats() {
        document.getElementById('completed-sessions').textContent = this.state.completedSessions;
    ...
    showNotification() {
        if ('Notification' in window) {
            if (Notification.permission === 'granted') {
                ...
                const message = this.state.mode === 'focus' 
    ...
    loadSettings() {
        ...
        document.getElementById('auto-start-focus').checked = this.settings.autoStartFocus;
