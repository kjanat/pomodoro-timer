...
export class PomodoroTimer {
  ...
  bindEvents(): void {
    ...
    document
      ...
      ?.addEventListener('change', (e) => {
        this.settings.focusDuration = parseInt((e.target as HTMLInputElement).value);
        this.saveSettings();
    ...
    document
      ...
      ?.addEventListener('change', (e) => {
        this.settings.shortBreakDuration = parseInt((e.target as HTMLInputElement).value);
        this.saveSettings();
      });
    ...
    document
      ...
      ?.addEventListener('change', (e) => {
        this.settings.longBreakDuration = parseInt((e.target as HTMLInputElement).value);
        this.saveSettings();
      });
    ...
    document
      ...
      ?.addEventListener('change', (e) => {
        this.settings.longBreakInterval = parseInt((e.target as HTMLInputElement).value);
        this.saveSettings();
      });
  ...
  updateStats(): void {
    ...
    if (completedSessionsElement) {
      completedSessionsElement.textContent = String(this.state.completedSessions);
    }
  ...
  loadSettings(): void {
    ...
    const autoStartBreaksInput = document.getElementById('auto-start-breaks') as HTMLInputElement;
    const autoStartFocusInput = document.getElementById('auto-start-focus') as HTMLInputElement;
    const soundEnabledInput = document.getElementById('sound-enabled') as HTMLInputElement;

    if (focusDurationInput) focusDurationInput.value = String(this.settings.focusDuration);
    if (shortBreakInput) shortBreakInput.value = String(this.settings.shortBreakDuration);
    if (longBreakInput) longBreakInput.value = String(this.settings.longBreakDuration);
    if (longBreakIntervalInput) longBreakIntervalInput.value = String(this.settings.longBreakInterval);
    if (autoStartBreaksInput) autoStartBreaksInput.checked = this.settings.autoStartBreaks;
    if (autoStartFocusInput) autoStartFocusInput.checked = this.settings.autoStartFocus;
